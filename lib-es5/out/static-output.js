...
function outputConsole(currentState) {
    ...
    if (rows.length) {
        ...
        console.log('Use ' + chalk.green('ncheck -' + (currentState.get('global') ? 'g' : '') + 'u') + ' for interactive update.');
        process.exitCode = 1;
    } else {
