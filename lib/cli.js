...
const cli = meow({
    help: `
        ...
        Examples
          $ ncheck           # See what can be updated, what isn't being used.
          $ ncheck ../foo    # Check another path.
          $ ncheck -gu       # Update globally installed modules by picking which ones to upgrade.
    `},
    {
        alias: {
            u: 'update',
